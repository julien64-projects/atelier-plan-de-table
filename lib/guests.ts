...
export const EVENEMENTS = [
  { key: 'welcome', label: 'Welcome dinner', court: 'Veille' },
  { key: 'cocktail', label: "Vin d'honneur", court: 'Cocktail' },
  { key: 'mariage', label: 'Mariage', court: 'Jour J' },
  { key: 'brunch', label: 'Brunch', court: 'Lendemain' },
] as const;
...
/** Récapitulatif chiffré : total, décompte par catégorie et par événement. */
export function recapInvites(guests: InviteRecapInput[]): Recap {
  ...
  return { total: guests.length, parCategorie, parEvenement };
}
